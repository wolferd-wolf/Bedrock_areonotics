...
class ClientLevelTickHook final {
public:
    ClientLevelTickHook(
    ...
    ClientLevelTickHook(const ClientLevelTickHook&) = delete;
    ClientLevelTickHook& operator=(const ClientLevelTickHook&) = delete;
...
private:
    ...
    static std::atomic<ClientLevelTickHook*> sActive;
};
